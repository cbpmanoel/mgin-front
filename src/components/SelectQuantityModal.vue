<template>
    <!-- Page overlay to highlight modal. Cancel is called if click outside the modal area -->
    <div @click="onCancel" class="z-40 modal-overlay" />
    <!-- Modal container -->
    <div class="z-50 modal-window">
        <!-- Modal content -->
...
.modal-window {
    @apply fixed inset-0 w-[300px] h-[300px] bg-gray-100 shadow-lg top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-md p-2;
}
